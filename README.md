...
- 조완석
  ...
  웹 프로젝트를 하면서 배웠던 개념들을 적용하고 커스텀하여 활용해보는 시간을 가졌습니다. 배웠던 기능들을 응용하는 일도 쉬운일이 아니었음을 느꼈고, 욕심을 내고 새로운 추가 기능을 더 구현하고자 하려면 몇배의 많은 시간을 쏟게 되었지만, 그만큼 더 새로운것들을 배우게 되었습니다. 혼자면 불가능했을 프로젝트를 좋은 팀원과 함께해서 일정내로 완성할 수 있었고, 서로 부족한 부분을 채워주고 서로에 대한 배려가 깊은 팀이라 더욱더 열심히 할 수 있었습니다.

- 신유빈

  지금까지 배운 내용들을 모두 적용하고 응용하며 프로젝트를 진행하다보니 헷갈렸던 개념들도 정리가 됐습니다. 백문이불여일견 이라고 많은 오류 페이지를 직접 만나 해결하는 과정을 통해 보다 성장할 수 있었습니다. 또한 개인이 아닌 팀으로 같이 협력하며 프로젝트를 진행함으로써 목표 서비스만큼의 완성도에 도달할 수 있었습니다. 같이 작업하면서 더 좋은 아이디어를 만들고 부족한 부분을 보완하며 함께하는 시너지 효과를 느꼈습니다. 덕분에 즐겁게 프로젝트 할 수 있었고 성장할 수 있는 좋은 경험이었습니다.